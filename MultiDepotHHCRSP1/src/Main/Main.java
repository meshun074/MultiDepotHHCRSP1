...
//            while (bestChromosome == null || bestChromosome.getFitness()==Double.POSITIVE_INFINITY){
...
//                    if (bestChromosome.getFitness() < max && bestChromosome.getFitness() != Double.POSITIVE_INFINITY) {
